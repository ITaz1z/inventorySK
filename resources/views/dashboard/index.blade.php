    ...
    <div class="row">
        ...
        @if($user->isAdminGudang())
            ...
            <div class="col-md-4 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <h2 class="display-4 fw-bold mb-1 text-dark">{{ $total_permintaan }}</h2>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-bottom-0">
                        <h5 class="mb-0"><i class="fas fa-info-circle me-2 text-primary"></i>Informasi</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <h2 class="display-4 fw-bold mb-1 text-dark">{{ $total_po_dibuat }}</h2>
                        <p class="mb-0 text-muted">Total PO Dibuat</p>
                    </div>
                </div>
            </div>
